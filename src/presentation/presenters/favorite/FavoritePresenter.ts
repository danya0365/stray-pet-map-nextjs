...
export class FavoritePresenter {
   ...
   */
  async getFavoritePostIds(): Promise<FavoriteIdsResult> {
    try {
      const postIds = await this.favoriteRepo.getFavoritePostIds();
   ...
   */
  async getFavoritePosts(): Promise<FavoritePostsResult> {
    try {
      const postIds = await this.favoriteRepo.getFavoritePostIds();
